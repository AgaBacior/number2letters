function convertNmb (numberUser) {
	...
	// if  var numberUser is a number or if var numberUser is between 0 and 999
	...
	// else var numberUser is correct so I proceed on conversion
	} else {
		...
		// I created four variables which i use later
		var convertUnits,
			convertTens,	
			convertHundreds,
			convertNumber;
